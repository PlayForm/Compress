...
var P = (...[r = {}]) => {
	Object.entries(r).forEach(([e, a]) =>
		Object.defineProperty(r, e, { value: a === !0 ? u[e] : r[e] }),
	);
	const {
			Path: o,
			Cache: s,
...
${(await import("kleur/colors")).bgGreen(
	(await import("kleur/colors")).black(" AstroCompress processing "),
)}`),
						typeof l == "object")
					) {
						n.size || n.add(e),
