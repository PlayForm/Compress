...
```sh
npm install -D -E Playform/AstroCompress#no-sharp
```
...
The utility will now automatically compress all your CSS, HTML, SVG and
JavaScript files in the Astro `outDir` folder.
